...
class ListaNFe extends Component {
    ...
    listarEvento = () => {
        ...
        const url = `${config.endpoint['fazemu-nfe']}/documentoFiscal?${parametros}`;
        console.log(url);
            ...
            pageOfItems.map((docu, key) => {
                rows.push(
                    <tr key={key}>
                        ...
                        <td className="text-center">{TipoEmissaoEnum[docu.tipoEmissao]}</td>
                        ...
                        <td className="text-center">
                            {this.renderButtonDANFE(docu.situacaoDocumento, docu.chaveAcesso)}
                        </td>
                        <td className="text-center">
                            <Link to={{ pathname: `/NFe`, documentoFiscal: docu }}>
    ...
    renderButtonDANFE(situacaoDocumento, chaveAcesso) {
